...
time.sleep(2)
#opens GSC "indexed and submitted" page
...
time.sleep(2)
#driver.find_element_by_class_name("jO7h3c").click() #clicks Google Sheet in drop down
driver.find_element_by_class_name('z80M1').click() #clicks Google Sheet in drop down
#print("Parent window title: " + driver.title)   #prints parent window title
#p = driver.current_window_handle #get current window handle
#chwd = driver.window_handles #get first child window
